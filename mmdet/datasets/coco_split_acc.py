...
from .cocoeval_wrappers_acc import COCOEvalWrapper, COCOEvalXclassWrapper
...
class CocoSplitDatasetAcc(CocoDataset):
    ...
    def __init__(self, 
        ...
        super(CocoSplitDatasetAcc, self).__init__(**kwargs)
        self.dataset_stat()
    ...
    def load_annotations(self, ann_file):
        ...
        self.train_cat_ids.append(1000) #  for pseudo box
        self.cat_ids.append(1000)
