...
class OlnRoIHead(StandardRoIHead):
    ...
    def _bbox_forward(self, x, rois):
        ...
        cls_score, bbox_pred, bbox_score, feat_cls, feat_loc = self.bbox_head(bbox_feats)

        bbox_results = dict(
            cls_score=cls_score, bbox_pred=bbox_pred, bbox_feats=bbox_feats,
            bbox_score=bbox_score, feat_cls=feat_cls, feat_loc=feat_loc)
        return bbox_results
    ...
    def _bbox_forward_train(self, x, sampling_results, gt_bboxes, gt_labels,
        ...
        loss_bbox = self.bbox_head.loss(bbox_results['cls_score'],
                                        ...
                                        bbox_results['feat_cls'],
                                        bbox_results['feat_loc'],
                                        rois,
                                        *bbox_targets)
    ...
    #     result_dict, _ = self.simple_test_bboxes(
