...
data = dict(
    ...
    train=dict(
        ...
        train_class='all',
        eval_class='all',
        ann_file='path/to/instances_train2017_withPseudoBox_allCOCO',
    ...
    val=dict( #UVO Test
        ...
        train_class='all',
        eval_class='all',
        ann_file = "path/to/UVO/ann/UVO_frame_val.json",
        img_prefix = "path/to/UVO/images/",
        type="CocoSplitDatasetAccUVO",
