...
custom_imports = dict(
    imports=['mmdet.datasets.coco_split_acc',
             'mmdet.models.losses.focal_loss_rpn',
             'mmdet.models.losses.focal_loss_roi',
             'mmdet.datasets.coco_split_acc_UVO',
             'mmdet.datasets.coco_split_acc_Objects365',
             'mmdet.core.bbox.assigners.max_iou_assigner_nooverlap'],
...
# Dataset
dataset_type = 'CocoSplitDatasetAcc'
...
data = dict(
    ...
    train=dict(
        ...
        train_class='coco',
        eval_class='noncoco',
        ann_file='/cluster_home/custom_data/datasets/objects365/zhiyuan_objv2_val.json',
        img_prefix='/cluster_home/custom_data/datasets/objects365',
        type='CocoSplitDatasetAccObj365',
...
evaluation = dict(  
    interval=1,  # 验证的间隔。
    metric_items=['mAP', 'AR@10', 'AR@50', 'AR@100', 'AR@300', 'AR@500'],
    metric=['bbox'])
